  ...
  const newsData = [
    {
      ...
      description: 'В Санкт-Петербурге на площадке ИнФинТех состоялась важная встреча представителей общественных организаций и активистов с участием Президента России Владимира Путина. Темой мероприятия стали итоги уходящего года и обсуждение перспектив развития страны. Среди участников также присутствовал президент Фонда иконы Святых Новомучеников юристов Петроградских, отметивший значимость исторического наследия и преемственности поколений. Владимир Путин подчеркнул необходимость тесного взаимодействия государства и гражданского общества для реализации стратегических задач и повышения качества жизни россиян. Встреча прошла в конструктивной и доброжелательной атмосфере, став платформой для открытого диалога и выработки совместных решений.',
      images: [
        'https://cdn.poehali.dev/files/82fd8aa3-b91e-4331-ad3e-dd3e123478dc.jpg',
        'https://cdn.poehali.dev/files/4181c2fe-1a37-4a60-a495-fbcd67988e7f.jpg',
      ],
    },
    {
