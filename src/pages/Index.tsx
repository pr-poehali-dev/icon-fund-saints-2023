          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                {
                  date: '15 ноября 2024',
                  title: 'Презентация новой книги о святых новомучениках',
                  description: 'Состоялась презентация издания, посвященного житиям святых новомучеников юристов',
                },
                {
                  date: '3 октября 2024',
                  title: 'Конференция "Новомученики и исповедники Российские"',
                  description: 'Прошла всероссийская конференция с участием историков и богословов',
                },
                {
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">info@fondnovomucheniki.ru</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">+7 (812) 000-00-00</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
