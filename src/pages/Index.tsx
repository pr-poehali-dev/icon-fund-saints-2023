              ...
              <div className="flex gap-4 sm:gap-6 min-w-max">
                {[
                  ...
                  },
                  {
                    ...
                    title: 'Паломничество к местам памяти',
                    description: 'Организована паломническая поездка по местам служения святых новомучеников юристов',
                  },
                  {
                    date: '10 августа 2024',
                    title: 'День памяти святых новомучеников',
                    description: 'Проведена торжественная литургия в честь святых новомучеников и исповедников Российских',
                  },
                  {
                    date: '5 июля 2024',
                    title: 'Издание книги житий',
                    description: 'Представлена новая книга о жизни и подвиге святых новомучеников юристов Петроградских',
                  },
                  {
                    date: '20 июня 2024',
                    title: 'Молебен в храме',
                    description: 'Совершен молебен святым новомученикам в Казанском соборе Санкт-Петербурга',
                  },
                  {
                    date: '15 мая 2024',
                    title: 'Научная конференция',
                    description: 'Проведена конференция, посвященная изучению истории новомучеников Российских',
                  },
                  {
                    date: '1 мая 2024',
                    title: 'Открытие выставки',
                    description: 'В музее открылась выставка, посвященная святым новомученикам юристам',
                  },
                  {
                    date: '20 апреля 2024',
                    title: 'Реставрация иконы',
                    description: 'Завершена реставрация старинной иконы святых новомучеников',
                  },
                  {
                    date: '10 апреля 2024',
                    title: 'Благотворительный вечер',
                    description: 'Организован благотворительный вечер в поддержку фонда святых новомучеников',
                  },
                  {
                    date: '1 апреля 2024',
                    title: 'Крестный ход',
                    description: 'Состоялся крестный ход в память о святых новомучениках и исповедниках',
                  },
                  {
                    date: '25 марта 2024',
                    title: 'Детский хор выступил',
                    description: 'Детский церковный хор исполнил песнопения в честь святых новомучеников',
                  },
                ].map((news, index) => (
